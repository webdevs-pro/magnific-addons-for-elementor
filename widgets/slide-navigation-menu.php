...
class Mae_Slide_Navigation_Menu_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Slide Navigation Menu', 'advanced-elementor-widgets' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Menu', 'advanced-elementor-widgets' ),
			]
		);
			...
			$this->add_control(
				...
				[
					'label' => __( 'Menu Height', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'auto',
					'options' => [
						'auto' =>  __( 'Auto', 'advanced-elementor-widgets' ),
						'by-higest' =>  __( 'By Higest Element', 'advanced-elementor-widgets' ),
						'custom' =>  __( 'Custom', 'advanced-elementor-widgets' ),
					],
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Menu Custom Height', 'advanced-elementor-widgets' ),
			...
			$this->add_control(
				...
				[
					'label' => __( 'Menu Scrollbar', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'default',
					'options' => [
						'default' =>  __( 'Default', 'advanced-elementor-widgets' ),
						'custom' =>  __( 'Custom', 'advanced-elementor-widgets' ),
					],
			...
			// 	[
			// 		'label' => __( 'Visible only on hover', 'advanced-elementor-widgets' ),
			// 		'type' => \Elementor\Controls_Manager::SWITCHER,
			// 		'label_on' => __( 'Yes', 'advanced-elementor-widgets' ),
			// 		'label_off' => __( 'No', 'advanced-elementor-widgets' ),
			// 		'return_value' => 'yes',
			// 		'default' => 'no',
			...
			$this->add_control(
				...
				[
					'label' => __( 'Scrollbar Side', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'left',
					'options' => [
						'left' =>  __( 'Left', 'advanced-elementor-widgets' ),
						'right' =>  __( 'Right', 'advanced-elementor-widgets' ),
					],
					'render_type' => 'template',
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Menu Indent', 'advanced-elementor-widgets' ),
					'type' => Controls_Manager::SLIDER,
					'default' => [
						'size' => 12,
					],
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Scrollbar Position', 'advanced-elementor-widgets' ),
					'type' => Controls_Manager::SLIDER,
					'default' => [
						'size' => 6,
					],
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Menu Vertical Align', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'flex-start',
					'options' => [
						'flex-start' =>  __( 'Top', 'advanced-elementor-widgets' ),
						'center' =>  __( 'Middle', 'advanced-elementor-widgets' ),
						'flex-end' =>  __( 'Bottom', 'advanced-elementor-widgets' ),
					],
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Menu Horizontal Align', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'flex-start',
					'options' => [
						'flex-start' =>  __( 'Left', 'advanced-elementor-widgets' ),
						'center' =>  __( 'Center', 'advanced-elementor-widgets' ),
						'flex-end' =>  __( 'Right', 'advanced-elementor-widgets' ),
					],
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Vertical spacing', 'advanced-elementor-widgets' ),
					'type' => Controls_Manager::SLIDER,
					'default' => [
						'size' => 0,
						'unit' => 'px',
			...
			$this->add_control(
				...
				[
					'label' => __( 'Submenu Indicator', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
			...
			$this->add_control(
				...
				[
					'label' => __( 'Back Item Label', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => __( 'Back', 'advanced-elementor-widgets' ),
				]
			);
			// back icon
			$this->add_control(
				...
				[
					'label' => __( 'Back Indicator', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Back Position', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'top',
					'options' => [
						'top' =>  __( 'Top', 'advanced-elementor-widgets' ),
						'bottom' =>  __( 'Bottom', 'advanced-elementor-widgets' ),
					],
					'render_type' => 'template',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Back Align', 'advanced-elementor-widgets' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' =>  __( 'Default', 'advanced-elementor-widgets' ),
						'flex-start' =>  __( 'Left', 'advanced-elementor-widgets' ),
						'center' =>  __( 'Center', 'advanced-elementor-widgets' ),
						'flex-end' =>  __( 'Right', 'advanced-elementor-widgets' ),
					],
			...
			$this->add_control(
				...
				[
					'label' => __( 'Animation Speed (ms)', 'advanced-elementor-widgets' ),
	...
	$this->start_controls_section(
		'section_style',
		[
			'label' => __( 'Style', 'advanced-elementor-widgets' ),
		...
		$this->start_controls_tabs( 'mae_slide_menu_text_style' );
			...
			$this->start_controls_tab(
				...
				[
					'label' => __( 'Normal', 'advanced-elementor-widgets' ),
				]
			);
				$this->add_control(
					'mae_slide_menu_color',
					[
						'label' => __( 'Text Color', 'advanced-elementor-widgets' ),
			...
			$this->start_controls_tab(
				...
				[
					'label' => __( 'Hover', 'advanced-elementor-widgets' ),
				]
			);
				$this->add_control(
					'mae_slide_menu_hover_color',
					[
						'label' => __( 'Hover Text Color', 'advanced-elementor-widgets' ),
						'type' => Controls_Manager::COLOR,
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => __( 'Underline', 'advanced-elementor-widgets' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => __( 'Yes', 'advanced-elementor-widgets' ),
						'label_off' => __( 'No', 'advanced-elementor-widgets' ),
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => __( 'Bold', 'advanced-elementor-widgets' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => __( 'Yes', 'advanced-elementor-widgets' ),
						'label_off' => __( 'No', 'advanced-elementor-widgets' ),
						'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Hover Transition Speed (ms)', 'advanced-elementor-widgets' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 100,
				'max' => 1000,
				'step' => 10,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Scrollbar Track Width', 'advanced-elementor-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 6,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Scrollbar track color', 'advanced-elementor-widgets' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Scrollbar track border', 'advanced-elementor-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Scrollbar track border radius', 'advanced-elementor-widgets' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Scrollbar Thumb Width', 'advanced-elementor-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 6,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Scrollbar thumb color', 'advanced-elementor-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#666',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Scrollbar thumb border', 'advanced-elementor-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Scrollbar thumb border radius', 'advanced-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
