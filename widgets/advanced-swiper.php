...
class Aew_Advanced_Swiper_Widget extends Widget_Base {

	public function get_name() {
		return 'mae_advanced_swiper';
	}

	public function get_title() {
		return __( 'Advanced Swiper', 'magnific-addons' );
	}
   ...
   public function get_row_selectors() {
      $legacy_mode = \Elementor\Plugin::instance()->get_legacy_mode( 'elementWrappers' );
      if($legacy_mode) {
         return '{{WRAPPER}} > .elementor-container > .elementor-row';
      } else {
         return '{{WRAPPER}} > .elementor-container';        
      }
   }

   public function get_column_selectors() {
      $legacy_mode = \Elementor\Plugin::instance()->get_legacy_mode( 'elementWrappers' );
      if($legacy_mode) {
         return '{{WRAPPER}} > .elementor-container > .elementor-row > .elementor-column';
      } else {
         return '{{WRAPPER}} > .elementor-container > .elementor-column';        
      }
   }
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( // ----------------------------------------------------------------------------------------------
			...
			[
				'label' => __( 'Advanced Swiper', 'magnific-addons' ),
			]
      );
         ...
         $this->add_control(
				'mae_as_stack',
				[
					'label' => __( 'Stack Columns', 'magnific-addons' ),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => __( 'On', 'magnific-addons' ),
					'label_off' => __( 'Off', 'magnific-addons' ),
               'return_value' => '1',
               'selectors' => [
                  // $this->get_row_selectors() => 'flex-wrap: wrap;',
                  '{{WRAPPER}} > .elementor-container > .elementor-row' => 'flex-wrap: wrap;',
         ...
         $this->add_control(
				'mae_as_fullwidth',
				[
					'label' => __( 'Fullwidth Columns', 'magnific-addons' ),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => __( 'On', 'magnific-addons' ),
					'label_off' => __( 'Off', 'magnific-addons' ),
               'return_value' => '1',
               'selectors' => [
                  // $this->get_column_selectors() => 'width: 100%;',
                  '{{WRAPPER}} > .elementor-container > .elementor-row > .elementor-column' => 'width: 100%;',
                  '{{WRAPPER}} > .elementor-container > .elementor-column' => 'width: 100%;',
               ],
               'render_type' => 'template',
				]
         );   
      ...
      $this->start_controls_section( // ----------------------------------------------------------------------------------------------
         ...
         $this->add_responsive_control(
            ...
            [
               ...
               'selectors' => [
                  // $this->get_column_selectors() => 'min-height: {{SIZE}}{{UNIT}} !important;',
                  '{{WRAPPER}} > .elementor-container > .elementor-row > .elementor-column' => 'min-height: {{SIZE}}{{UNIT}} !important;',
                  '{{WRAPPER}} > .elementor-container > .elementor-column' => 'min-height: {{SIZE}}{{UNIT}} !important;',
               ],
            ]
         );
         // effect
   ...
   protected function render() {
      ...
      if ($widget_settings['mae_as_navigation'] == '1') {
         ...
         if ($widget_settings['mae_as_arrows_type'] == 'icon') {
               ...
               ob_start();
                  ?><div class="advanced-swiper-button-prev elementor-icon"><?php \Elementor\Icons_Manager::render_icon( $widget_settings['mae_as_arrows_prev_icon'], [ 'aria-hidden' => 'true' ] ); ?></div><?php
               $slider_settings['navigation']['prev_button'] = str_replace(array("\r\n", "\r", "\n", "\t"), "",ob_get_clean());

               ob_start();
                  ?><div class="advanced-swiper-button-next elementor-icon"><?php \Elementor\Icons_Manager::render_icon( $widget_settings['mae_as_arrows_next_icon'], [ 'aria-hidden' => 'true' ] ); ?></div><?php
      ...
      ?>
         ...
         <script>
            ...
            //console.log('PHP');
            //. preg_replace('/[^a-zA-Z0-9]/', '', (string) $widget_settings['mae_as_target'])
 ...
 * 
 */
$add_css = new MAE_Post_CSS('mae_advanced_swiper', 'mae_as_target');
